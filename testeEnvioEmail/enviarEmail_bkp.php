...
$return = new stdClass();
$emailInformata = "eujoaonetoti@outlook.com";
...
$headers .= "From: eujoaonetoti@outlook.com".PHP_EOL;

$bolRetorno  = mail($to,$subject,$message,$headers);

$return->returnMailClient    = $bolRetorno;
